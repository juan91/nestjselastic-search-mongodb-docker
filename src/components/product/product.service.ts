...
export class ProductService implements ProductServiceInterface {
  ...
  async delete(idProduct: string): Promise<DeleteResult> {
    //await this.productEsIndex.deleteProductDocument(idProduct);
    return await this.productRepository.remove(idProduct);
  }
